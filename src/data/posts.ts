...
export const initialPosts: Post[] = [
  ...
  {
    id: 3,
    title: 'Webtechnik-Praktikum braucht klarere Abgaben',
    category: 'Praktikum',
    author: 'Samir',
    studyProgram: 'Architektur',
    semester: 5,
    body: 'Die Praktikumsaufgaben sind gut, aber die Bewertungskriterien sollten vor der Abgabe genauer beschrieben werden.',
